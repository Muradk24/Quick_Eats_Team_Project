    ...
    private fun setView() {
        ...
        menuAdapter.itemClickListener = {
            findNavController().navigate(
                R.id.action_menuListFragment_to_detailActivity,
                bundleOf("menuId" to it.menuId)
            )
        }
        mBinding.apply {
...
// This method is called once with the initial value and again
            ...
            if (task.isSuccessful) {
                ...
                mBinding.rvCategory.visibility =
                    if ((response.menu as ArrayList<MenuItemModel>).isEmpty()) View.GONE else View.VISIBLE
                mBinding.tvNoData.visibility =
                    if ((response.menu as ArrayList<MenuItemModel>).isEmpty()) View.VISIBLE else View.GONE
            } else {
